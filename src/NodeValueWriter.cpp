...
namespace NodeOpenDDS {
  ...
  NodeValueWriter::NodeValueWriter() : next_index_(0), use_bigint_(true) {}
  ...
  bool NodeValueWriter::begin_sequence(OpenDDS::XTypes::TypeKind /*elem_kind*/,
  ...
  bool NodeValueWriter::begin_map(OpenDDS::XTypes::TypeKind /*key_kind*/,
...
#ifdef HAS_BIGINT
    if (use_bigint_) {
      v8::MaybeLocal<v8::BigInt> v8_value =
          v8::BigInt::New(v8::Isolate::GetCurrent(), static_cast<int64_t>(value));
      ret = value_helper<v8::BigInt>(v8_value);
    } else {
#endif
      char buff[21]; // 2^63 is 19 characters long in decimal representation, plus optional sign,
                     // plus null
  ...
  bool NodeValueWriter::write_uint64(ACE_CDR::ULongLong value)
  {
    ...
    if (use_bigint_) {
      v8::MaybeLocal<v8::BigInt> v8_value =
          v8::BigInt::NewFromUnsigned(v8::Isolate::GetCurrent(), static_cast<uint64_t>(value));
      ret = value_helper<v8::BigInt>(v8_value);
    } else {
#endif
  ...
  bool NodeValueWriter::write_bitmask(ACE_CDR::ULongLong value,
