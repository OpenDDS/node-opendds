...
namespace NodeOpenDDS {
  ...
  public:
    ...
    template <typename V> bool value_helper(v8::MaybeLocal<V>& v8_value)
    {
      if (v8_value.IsEmpty()) {
        return false;
      }
    ...
    template <typename T, typename V> bool primitive_helper(T value)
    {
    ...
    template <typename T> bool object_helper()
    {
