...
my $publisher_name = "test_publisher";
my $publisher_args = "";
if ($secure) {
  $publisher_name .= "_secure";
  $publisher_args .= "-DCPSConfigFile rtps_disc.ini";
}
my $PUB = PerlDDS::create_process($publisher_name, $publisher_args);
